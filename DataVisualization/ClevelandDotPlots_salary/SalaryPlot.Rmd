...
```{r}
TidyGenderData <- read.csv('/Users/tracy/Desktop/STAT5702_NYC_Employment_Analysis/DataPreprocessing/salary/TidyGenderData.csv')
...
GenderSalary2 <- GenderSalary %>% select(1,8) %>% unique()
