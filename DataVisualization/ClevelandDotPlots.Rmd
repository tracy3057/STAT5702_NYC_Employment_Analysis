...
YearlyDataWithVariance <- YearlyDataWithVariance %>% mutate(variance_pct = variance/NumEmps)
...
GenderData.tidy <- GenderData.tidy %>% mutate(variance_pct = variance/NumEmps)
