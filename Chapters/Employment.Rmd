...
xlab <- c(0,100,200,300,400,500,600,700,800)

ggplot(TrimmedAggregateYearlyData) +
geom_point(aes(YearlyNumEmp, reorder(Occupations,YearlyNumEmp), color = year)) + ylab('Occupation') + xlab('Number Employed') + ggtitle('Number Employed by Occupation NYC 2010-2019') + scale_x_continuous(labels = paste0(xlab, "K"),breaks = 10^3 * xlab) +
...
xlab <- c(0,100,200,300,400,500,600)
...
ylab <- c(60,70,80,90,100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,
          275,300,325,350,375,400,425,450,475,500,525,550,575,600,625,650,700,750,800,850,900,950,1000)
ylab <- seq(0,900,by=25)
ylab 
...
ggplot(NotMonotonous,aes(year,YearlyNumEmp)) +
  ...
  ylab('Number of Employees') + xlab('Occupations') + ggtitle('Number Employed in NYC by Occupations')
```
