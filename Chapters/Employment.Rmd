...
YearBoroughData.tidy$Occupations <- plyr::revalue(YearBoroughData.tidy$Occupations, c("Management, business, science, and arts" = "MBSC", "Natural resources, construction,maintenance" = "NRCM", "Production, transportation,material moving" = "PTMM"))
