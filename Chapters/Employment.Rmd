...
YearBoroughData.wide['sumnumemp'] <- YearBoroughData.wide['Management, business, science, and arts']+YearBoroughData.wide['Service']+YearBoroughData.wide['Sales and office']+YearBoroughData.wide['Natural resources, construction,maintenance']+YearBoroughData.wide['Production, transportation,material moving']

YearBoroughData.wide['Management, business, science, and arts'] <- YearBoroughData.wide['Management, business, science, and arts']/YearBoroughData.wide['sumnumemp']
...
YearBoroughData.wide['Natural resources, construction,maintenance'] <- YearBoroughData.wide['Natural resources, construction,maintenance']/YearBoroughData.wide['sumnumemp']
YearBoroughData.wide['Production, transportation,material moving'] <- YearBoroughData.wide['Production, transportation,material moving']/YearBoroughData.wide['sumnumemp']
...
ggplot(GenderData, aes(MeanNumEmpbyGender,fct_reorder2(Occupations,Gender=='Female',MeanNumEmpbyGender, .desc=FALSE), color = Gender)) + 
  ...
  ylab('NumEmps') + xlab('Occupations') + ggtitle('Number Employed by Occupation and Gender in NYC') +
...
ggplot(PropsOfPropsRaceTidy, aes(fill = race, y = Occupation, x = Proportion)) + geom_bar(position = 'stack',stat = 'identity') + ggtitle('Relative Likelihood of Sector Employment by Race') + 
  mytheme2
