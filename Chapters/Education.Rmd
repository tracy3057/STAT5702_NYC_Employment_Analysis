...
ggplot(data = SalaryByPropEdu,aes(PropEdu,Salary)) + 
  ...
  ylim(30000,65000) + 
  ggtitle("Proportion with Bachelors Degree vs Average NYC Salary from 2010-2019") +
...
It appears that the proportion of people with Bachelor's Degrees is steadily increasing over time. In the last 10 years the proportion of people with a bachelors has increased from slightly below 55% more than 59% which indicates an average increase of just under half a percent per year.
