...
ggplot(NewSalaryWithVariance1,aes(x=fct_reorder(Occupations, abs(variance_pct)), y = variance_pct)) +
  ...
  coord_flip()+
    theme(axis.text=element_text(),
      ...
      plot.title = element_text(face = "bold"))+ xlab('Occupations') + ylab('Percentage Difference') + ggtitle('Difference in Percentage of Salaries over Years')+
  mytheme
```
...
Among all the occupations, Healthcare support and Law enforcement workers has the smallest variance after normalized. 
