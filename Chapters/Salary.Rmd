...
## Percentage Difference in salaries between different counties
...
ggplot(GenderSalary,aes(x=fct_reorder(Occupations, abs(variance_pct)), y = variance_pct)) +
  ...
  coord_flip()+
    theme(axis.text=element_text(),
      axis.title=element_text(face="bold"),
      plot.title = element_text(face = "bold"))+ xlab('Difference_pct') + ylab('Occupations') + ggtitle('Percentage Difference of Salaries for Different Genders')+
  mytheme
